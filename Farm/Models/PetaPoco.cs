...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        internal void DoPreExecute(IDbCommand cmd)
        {
           ...
           //hyhhyh _lastArgs = (from IDataParameter parameter in cmd.Parameters select parameter.Value).ToArray();
            _lastArgs = (from IDataParameter parameter in cmd.Parameters where parameter!=null select parameter.Value).ToArray();
        }
